  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
        ...
        displayBlock.append("<p><div class='admin-options'>  <div class='header-admin-options'>  <h2>Admin Options</h2>  </div>  <div class='options-admin'>  <div class='card' id='div1' onclick='redirectedadministrationpage()'>  <h1>  Admin Options  </h1>  </div>  <div class='card' id='div2' onclick='redirectvotingpage()'>  <h1>  Voting Page  </h1>  </div>  </div>  </div></p>");
