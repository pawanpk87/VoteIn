...
<html>
    ...
    <body>
        ...
        StringBuffer displayBlock=new StringBuffer("<div class='admin-options'>  "
                + "<div class='header-admin-options'>  <h1><strong> Manage User</strong></h1>  </div>  "
                + "<div class='options-admin'>  "
                + "<div class='card' id='div1' onclick='showAllUsers()'>  <img src='images/adduser.svg' />  <h3>Show Users</h3></div>"
                + "<div class='card' id='div1' onclick='removeuser()'>  <img src='images/removeuser.svg' />  <h3>Remove User</h3></div> "
                + "<div class='card' id='div1' onclick='showupdateuserform()'>  <img src='images/updateuser.svg' />  <h3>Update User</h3></div> "
                + "</div></div>");
