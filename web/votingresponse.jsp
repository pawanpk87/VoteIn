...
<html>
    ...
    <body>
        ...
        <%
             ...
             if(candidate == null)
             {
                 displayBlock.append("<p><div class='admin-options'>  <div class='header-admin-options'>  <h2>Voting Details</h2>  </div>  <div class='options-admin'>  <div class='card' id='div1'>  <h1>Sorry! Your vote could not be casted</h1>  </div>  </div>  </div></p>");
             }
             else
             {
                 displayBlock.append("<p><div class='admin-options'>  <div class='header-admin-options'>  <h2>Voting Details</h2>  </div>  <div class='options-admin'>  <div class='card' id='div1'>  <h1>Thank you for voting!</h1>  </div>  </div>  </div></p>");
